            ...
            {[
              {
                ...
                body: 'Every recommendation is backed by research or data — not whoever argues loudest in the room.',
              },
              {
                title: 'Direct access',
                body: 'You talk to the people doing the work. No account layers, no message relay.',
              },
              {
                title: 'Ownership at handover',
                body: 'You leave with systems and documentation you can run without us, if you choose to.',
              },
            ].map((v) => (
